...
class Grid:
    ...
    def __init__(
        ...
        # RASTREO VISUAL DE DRONES EN CONEXIONES
    ...
    def _find_movement(self):
        ...
        # 1. Comprobar drones en Zonas (desde la meta hacia el inicio)
        ...
        # 2. Comprobar drones que estaban en Conexiones
    ...
    def animate_changes(
        ...
        while True:
            ...
            # Actualizar contenedores visuales origen
            if isinstance(origin_obj, Zone):
            ...
            # Actualizar contenedores visuales destino
            if isinstance(dest_obj, Zone):
